...
export const landing = {
  ...
  hero: {
    ...
    advantages: [
      ...
      "Shorter sales cycles with prospects who arrive pre-sold",
      "Authority that compounds like equity",
    ],
  ...
  problem: {
    title: "Two founders. Same problem. Different disguise.",
    paragraphs: [
      "You built something real. The product works, the clients stay, referrals trickle in. But outside your existing circle? Silence. You're the best-kept secret in your industry, and that's not the compliment it sounds like.",
      "Or perhaps you're not invisible at all. You post. You publish. You show up. And yet the leads are tepid, the deals take too long, and the people who find you don't seem to understand what you actually do. Activity without architecture is just noise with a content calendar.",
      "Both versions share the same root cause: you have a reputation, but not a brand. One requires proximity. The other works while you sleep.",
  ...
  who: {
    title: "Built for founders who measure in revenue, not reach.",
    paragraphs: [
      "This is for entrepreneurs and business owners who've already proven they can build. What they haven't built yet is the market position that matches their actual calibre.",
      "You operate in sectors where trust isn't optional, it's the transaction. You don't need someone to teach you LinkedIn. You need someone to make your market position so clear that the right clients feel foolish going elsewhere.",
      "You've likely considered doing this before. Maybe you tried. Maybe you hired someone who delivered followers when you needed pipeline. Or content when you needed positioning. Or advice when you needed architecture. The experience left you sceptical of the category, which, frankly, is a reasonable response to most of what this industry produces.",
      "We're not here to restore your faith in personal branding agencies. We're here to make the distinction irrelevant by delivering something you can measure.",
    ],
  },
  ...
  proof: {
    ...
    placeholder:
      "Client testimonials go here — 2–3 short quotes from founders or entrepreneurs, ideally referencing commercial outcomes: deals closed, inbound increase, time-to-close reduction, investor traction. Keep them specific and unadorned. No superlatives.",
  },
  ...
  faq: {
    ...
    items: [
      {
        q: "How is this different from hiring a PR agency?",
        a: "PR gets you mentioned. We get you chosen. A PR agency places stories. We build the strategic position that makes those stories, and every other touchpoint, convert into business. Media is one tool. It's never the strategy.",
      },
      {
      ...
      },
      {
        ...
        a: "We can. But that's not the point. We build the strategy and messaging architecture that makes your content work. Whether we execute it, your team does, or we do it together depends on what makes sense for your business.",
      },
      {
        q: "What does it cost?",
        a: "We work on retained engagements tailored to scope. This isn't a productised service, because your positioning shouldn't be either. Book a strategy call. We'll scope it properly and give you a clear number.",
      },
      {
        q: "I'm already well-known in my industry. Do I need this?",
        a: "Known and positioned aren't the same thing. If your reputation doesn't generate inbound revenue from outside your existing network, it's a ceiling, not a platform. We turn local authority into market position.",
      },
      {
        q: "I've been burned by agencies before. Why would this be different?",
        a: "Probably because the last one sold you activity, not outcomes. Content calendars, post schedules, follower counts. None of which answered the only question that matters: did it generate revenue? We start with that question. Everything we build is measured against it. If that sounds obvious, ask your last agency why they didn't do it.",
      },
    ],
  },
