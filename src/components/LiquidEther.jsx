...
`;
    ...
    const io = new IntersectionObserver(
      entries => {
        ...
        if (!webglRef.current) return;
        // Check local pause prop instead of just document.hidden
        if (isVisible && !document.hidden && !isPausedRef.current) {
  ...
  // Use a ref to track isPaused inside the IntersectionObserver callback
